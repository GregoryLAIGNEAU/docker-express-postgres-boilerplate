import { getRequiredEnv, isProduction, loadSecretFile } from "#utilities/envUtility.mjs";
...
export const DB_CONFIG = {
  ...
  PG_PASSWORD: loadSecretFile("db_password"),
...
export const REDIS_CONFIG = {
  ...
  REDIS_PASSWORD: loadSecretFile("redis_password"),
...
export const SMTP_CONFIG = {
  ...
  SMTP_PASSWORD: loadSecretFile("smtp_password"),
...
export const TOKEN_ENV = {
  ACCESS_TOKEN_SECRET: loadSecretFile("access_token_secret"),
  ACCESS_TOKEN_EXPIRY_MINUTES: parseInt(process.env.ACCESS_TOKEN_EXPIRY_MINUTES || "15", 10),
  REFRESH_TOKEN_SECRET: loadSecretFile("refresh_token_secret"),
...
export const SECURITY_ENV = { CSRF_SECRET: loadSecretFile("csrf_secret"), COOKIE_SECURE: isProduction };
